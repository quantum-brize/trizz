...
<title><?php echo stripslashes($rest['name']); ?> - Holidays - <?php echo $websitesetting['metaTitle']; ?></title>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/magnific-popup.min.css" integrity="sha512-+EoPw+Fiwh6eSeRK7zwIKG2MA8i3rV/DGa3tdttQGgWyatG/SkncT53KHQaS5Jh9MNOT3dmFL0FjTY08And/Cw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
 ...
 .actiimgbox{width:100%; border-radius: 10px; overflow:hidden;}
 .actiimgbox img{width:100%; min-height:90px;}
 ...
 .leftfullimg{height: 320px !important;} 
 .hoteldetailone h1{font-size: 29px;}
 .middleimg .col-lg-6{padding-right: 3px !important; padding-bottom: 7px !important;}
 .fixheightimg{border-radius: 3px !important;}
 .fixheightimg img{border-radius: 3px !important;}
 .leftfullimg{border-radius: 3px !important;}
 .leftfullimg img{border-radius: 3px !important;}
 .datebg{background-color: #f3f3f3;}
 .list-group-item { border: none; padding: 4px; width: 80%; padding-left: 20px; margin-bottom: 3px; }
 .list-group-item:hover{border-radius: 0 20px 20px 0;}
 .dayslidetabs{margin-bottom: 20px;border-radius: 0px;}
 .dayslidetabs a.active {color: #fff;background: #4a4a4a;border-radius: 0 20px 20px 0;}
 .menudraglist{background-color: #fff; padding: 3px 15px; border-radius: 5px; border: 1px solid #dddddd6e;padding-left: 0px; margin-top:-30px;}
 .menudraglist .active {color: #d72e36;border-bottom: 4px solid #d72e36;padding-bottom: 12px !important;}
 .dayslidetabs .row .row{padding: 10px !important; margin: 10px 0px !important; box-shadow: 0px 0px 10px #ccc !important; border-radius: 10px !important;}
.flexdayhead h3{font-size:13px;}
.fixheightimg { height: 152px !important; margin-bottom: 15px; }
.subbtn2{background: #ffb800 !important; color: #000 !important;}

@media(max-width: 576px){
.hoteldetailone h1{font-size: 18px !important;margin-bottom: 5px !important;}
.holidatnightbox{margin-bottom: 5px !important;}
#toppriceht{font-size: 18px !important;margin-bottom: 4px !important;}
.mobileinhides{display: none !important;}
.itenaryrow .col-lg-8{padding-right: 12px !important;padding-left: 12px !important;}
.dayslidetabs .col-lg-3{display: none !important;}
.dayslidetabs .col-lg-9{width: 100% !important;}
.flexdayhead h3{overflow: hidden; text-overflow: ellipsis; white-space: nowrap;}
.leftfullimg{margin-left: 2px !important;height: 200px !important;}
.roompricing p{margin-bottom: 6px !important;}
.menudraglist ul li{padding: 5px 11px !important;}
.menudraglist ul li a{font-size: 14px !important;padding-bottom: 6px !important;}
.menudraglist .active{padding-bottom: 6px !important;}
#packagedetails{margin-top: 10px !important;}
#scroll-amenities{font-size: 16px !important;}
}
 </style>
</head>
 ...
 <section class="hotelgallery">
        <div class="container">
            <div class="hoteldetail">
                ...
                <div class="hoteldetailtwo">
                    <div class="roompricing">
                        <div>
                            <h3><strong id="toppriceht" style="font-size:22px;"><strong id="toppriceht"><?php echo convertfromtocurrencywithcurr('INR',$_SESSION['currency'],round($rest['grossPrice'])); ?> </strong></strong></h3>
                            <p>Best Price</p>
                        </div>
			...
			<div class="row itenaryrow">
                <div class="col-lg-8" style="padding-left: 0px; border-left: 0px;padding-right: 20px;">
            ...
            <div class="row gallerys">
               ...
               <div class="col-lg-12">
                 <div class="row middleimg">
                    <div class="col-lg-6" style="padding-right: 9px !important;">
...
?>
                    <a href="<?php if($rest['agentId']==0){ echo $packagephotourl.$res1['image'];  } else { echo $packagephotourl.$res1['image']; } ?>">
                    <img onerror="this.onerror=null;this.src='<?php echo $fullurl; ?>images/nohotelimage.png';" src="<?php if($rest['agentId']==0){ echo $packagephotourl.$res1['image'];  } else { echo $packagephotourl.$res1['image']; } ?>" alt="">
                    </a>
					<br>
<?php } ?>
		...
		<?php 
$a1=GetPageRecord('*','itinerariesGallery','  itinerariesId	="'.$rest['id'].'"   order by id asc ');  
while($res1=mysqli_fetch_array($a1)){ 
?>
                    <a href="<?php if($rest['agentId']==0){ echo $packagephotourl.$res1['image'];  } else { echo $packagephotourl.$res1['image']; } ?>" style="display:none;">
                    <img onerror="this.onerror=null;this.src='<?php echo $fullurl; ?>images/nohotelimage.png';" src="<?php if($rest['agentId']==0){ echo $packagephotourl.$res1['image'];  } else { echo $packagephotourl.$res1['image']; } ?>" alt="">
                    </a>
					<br>
<?php } ?>
                    ...
                    <div class="col-lg-6 mobileinhides">
                        <div class="row">
						
						<?php 
$a1=GetPageRecord('*','itinerariesGallery','  itinerariesId	="'.$rest['id'].'"   order by id asc limit 1,2');  
while($res1=mysqli_fetch_array($a1)){ 
?>
                            <div class="col-lg-12">
                ...
                <div class="menudraglist">
                    <ul>
                        <li><a class="active" href="#packagedetails" >SUMMARY</a></li>
                        <li><a href="#daywise">ITINERARY</a></li>
                        <li><a href="#policy">POLICIES</a></li>
                    </ul>
                </div>

                    <div class="card" style="border: 1px solid #dddddd6e;"  id="packagedetails">
                            <div class="description holidaydetaildes">
                           <h1 id="packagedetails">Package <span>Overview</span></h1>
...
<div class="container dayslidetabs">
<div class="row">
    <div class="col-lg-3">
        <h5 class="dayheadingplan" id="daywise">Day Plan</h5>
...
?>
  <a class="active list-group-item list-group-item-action" href="#list-item-<?php echo $n; ?>">Day <?php echo $n; ?></a> 
  <?php $n++;} ?>
</div>
    </div>
...
?>
    <div id="list-item-<?php echo $n; ?>" style="    margin-bottom: 30px;">
    <div>
       <div class="flexdayhead"> <h3>Day <?php echo $n; ?>  - <?php echo stripslashes($dayDetailsData['daySubject']); ?></h3>
      </div>
        <p class="daywisecontent"><?php echo nl2br(stripslashes($dayDetailsData['dayDetails'])); ?></p>
...
<div class="<?php if($eventData['sectionType']=='Flight'){ ?>col-md-3 col-xl-3<?php } else { ?>col-md-3 col-xl-3<?php } ?>" style="position:relative;">
<div class="<?php if($eventData['sectionType']=='Flight'){ ?>actiimgboxflight<?php } else {  ?>actiimgbox<?php } ?>"><img id="eventimage<?php echo $eventData['id']; ?>" <?php if($eventData['sectionType']=='Flight'){ ?> style="height:100%;" <?php } ?>  src="<?php echo $packagephotourl; ?><?php if($eventData['eventPhoto']!=''){ echo $eventData['eventPhoto']; } else {  if($eventData['sectionType']=='Accommodation' ){ echo 'nohotel.png'; }  if($eventData['sectionType']=='Cruise' ){ echo 'nohotel.png'; }if($eventData['sectionType']=='FeesInsurance' ){ echo 'nofee.png'; }if($eventData['sectionType']=='Flight' ){ echo 'noother.png'; } } ?>" /></div>
...
while($listdataterm=mysqli_fetch_array($rsa)){ ?>
							...
							<div class="card" style="    border: 1px solid #dddddd6e;">
						 ...
						 <?php echo nl2br(stripslashes($listdataterm['description'])); ?>
 ...
 <div class="card rightformcard2" style="border: 1px solid #dddddd6e; background-color:#fff;margin-top:0px;">
...
<div style="font-size:11px; color:#fff;">Provide Your Details to Know Best Holiday Deals</div>
...
<form action="frmaction.html" method="post" target="actoinfrm"><div class="row">
 ...
 <div class="filedlable">Destination</div>
 	<div style="height:0px; font-size:0px; position:relative; width: 100%; text-align: left;" id="searchcitylistsfromCity3"></div>
	  <input  type="text"  class="form-control" requered=""  name="citydestination" value=" <?php echo ($rest['destinations']); ?>" autocomplete="nope" style="font-size:13px;"  placeholder="Destination Name"    required="required">
 ...
 <button type="submit" class="btn btn-danger subbtn2" style="width: 100%; padding:10px 0px; text-align:center;">Send Enquiry</button>
  </div>
</div></form>
...
<div id="showflightbookingcancelaltionthanks" style="display:none;">
 ...
 <div class="card assiscard" style="    border: 1px solid #dddddd6e;">
<div class="card-body" style="padding:10px 20px;">
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div style="margin-bottom:2px; margin-top:10px;"><i class="fa fa-phone" aria-hidden="true"></i> <?php echo $websitesetting['contactPhone']; ?></div>
	<i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:<?php echo $getcompanybasicinfo['email']; ?>"><?php echo $websitesetting['contactEmail']; ?></a>	</td>
  </tr>
</table>
