                        ...
                        <table class="table table-hover mb-0">
                           <thead>
                              <tr>
                                 ...
                                 <th>
                                    <div align="center">GST Amount </div>
                                 </th>
                                 <th>
                                    <div align="center">TDS</div>
                                 </th>
                                 <th>
                           ...
                           <tbody>
                              <?php 
                                 ...
                                 $rs=GetRecordList('*','sys_balanceSheet',' where 1 and amount>0 and bookingId in (select BookingNumber from hotelBookingMaster where status=2) and billType="hotel" group by bookingId  order by id desc  ','100',$page,$targetpage); 
                                 $totalentry=$rs[1]; 
                                 $paging=$rs[2];  
                                 ...
                                 $ag=GetPageRecord('*','sys_userMaster',' id in (select parentId from sys_userMaster where id ="'.$rest['agentId'].'") '); 
                                 $agentData=mysqli_fetch_array($ag);
                                 ?>
                              <tr>
                                 ...
                                 <td align="left" valign="top">
                                    <div align="center"><?php echo  round($bookingdata['agentCommision']); $gstamount=round($bookingdata['agentCommision']*18/100); $tds=round($bookingdata['agentCommision']*5/100); ?></div>
                                 </td>
                                 <td align="left" valign="top">
                                    <div align="center"><?php echo stripslashes($totalpriceofgst); ?></div>
                                 </td>
                                 <td align="left" valign="top">
                                    <div align="center">18%</div>
                                 </td>
                                 <td align="left" valign="top">
                                    <div align="center"><?php if($bookingdata['agentCommision']==0){ echo stripslashes($rest['amount']); } else { echo $gstamount; }?></div>
                                 </td>
                                 <td align="left" valign="top">
                                    <div align="center"><?php echo $tds; ?></div>
                                 </td>
                                 <td align="left" valign="top">
                                    <div align="center"><?php echo round(($bookingdata['agentTotalFare']+$gstamount+$tds)-$bookingdata['agentCommision']); ?></div>
                                 </td>
                              </tr>
                              <?php $sNo++; } ?>
                           </tbody>
