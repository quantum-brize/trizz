...
deleteRecord('agent_fareTypedomesticFlightsMarkupMaster',' flightId="'.$id.'"  ');
}
?>
...
$n=1;  
$roomslist='';
 $rs=GetPageRecord('*','fareTypedomesticFlightsMarkupMaster',' flightId="'.$id.'"  order by id desc');
...
<?php
$roomslist='';
$a=GetPageRecord('*','fareTypedomesticFlightsMarkupMaster',' flightId="'.$id.'"   order by id desc');
