...
$hotelPrice=mysqli_fetch_array($rs); 
 ...
 $adultcost=0;
				...
				if($adult<3 && $hotelPrice['id']>0){
				 ...
				 $adultcost=$hotelPrice['adultCost']+$hotelPrice['mealCost'];
				 $finalmealcost+=$hotelPrice['mealCost'];
				...
				if($age1>2 && $child>0){
				$childcostone=$hotelPrice['childCost']+$hotelPrice['mealCost'];
				 $finalmealcost+=$hotelPrice['mealCost'];
				}
				
				if($age2>2 && $child==2){
				$childcosttwo=$hotelPrice['childCost']+$hotelPrice['mealCost'];
				 $finalmealcost+=$hotelPrice['mealCost'];
				} 
				if($age2<3 && $child==2){
		  ...
		  $finalroomcost+=($adultcost+$childcostone+$childcosttwo)*$numberOfNights;
			...
			$hotelPrice=mysqli_fetch_array($rs); 
				 ...
				 $adultcost=$hotelPrice['adultCost']+$hotelPrice['extraBed']+$hotelPrice['mealCost'];
				  $finalmealcost+=$hotelPrice['mealCost'];
				   $finalmealcost+=$hotelPrice['mealCost'];
...
<form id="flightbookingsubmit" method="post" action="hotel-request-action-page" >
...
<?php 
 ...
 <div class="card-header">Contact Details</div>
  ...
  <div class="card-footer text-muted" id="showfooterpay" style="display:none;">
   ...
   <button type="button" class="btn btn-danger btn-sm" style="float:right;" onClick="$('#steponeflightdetails').hide();$('#steptwopassengerdetails').hide();$('#stepfourpayments').show();$('.flightreviewbox').removeClass('active');$('#strp4').addClass('active');$('.hidefooter').show();$('#showfooterpay').hide();$('#stepfourpayments').show();">Proceed To Request</button>
...
<div class="col-12">
<div class="card-body"> 
<div style="padding-top:10px; padding-bottom:10px; font-size:14px;"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp; By placing this request, you agree to our Terms Of Use and Privacy Policy</div>
...
<button type="button" class="btn btn-danger" onClick="payandbooknow();" >Submit Request</button>
</div>
