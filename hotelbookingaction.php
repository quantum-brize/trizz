...
//$retrunhoteloffline=1;
 ...
 if($_REQUEST['ResultIndex']!='' && $_REQUEST['HotelCode']!='' && $_REQUEST['HotelName']!=''){
...
if($_REQUEST['IsVoucherBooking']==1){
$IsVoucherBooking='false';
} else { 
