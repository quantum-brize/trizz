...
<div id="DivIdToPrint" style=" margin: auto; background-color:#F8F8F8;">
...
<strong> </strong> <?php echo stripslashes($agentData['email']); ?><br />
  ...
  <tr>
    <td colspan="3"><table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#000000">
      <tr>
        <td colspan="2" align="left" valign="top" style="border-right:1px solid #000;">Booking Id: <strong><?php echo encode($editresult['id']); ?></strong>  <br />
	...
	<table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#CCCCCC">
     ...
     <?php if($editresult['seatPrice']>0){ ?> <tr>
      ...
      <tr>
        ...
        <td colspan="2">Rs.<?php echo number_format($editresult['agentTotalFare']+($_REQUEST['markup'])); ?></td>
      </tr>
    </table>
	<?php } ?>
