...
$RowSeats= $ssr_result['Response']['SeatDynamic'][0]['SegmentSeat'][1]['RowSeats'];
...
<div id="select-busseats" class="" role="dialog" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title">Seat		<div style="font-size:12px;">Click on Seat to select/ deselect</div></h5>
...
<div style="background-image: url(images/ic_flightSmallTail.aa15f774.png); background-repeat: no-repeat; background-size: 100% auto; width: 280px; height:355px; margin: auto; position:relative;">
  ...
  <tr>
    <td>Selected Seat:</td>
    <td><span class="font-weight-medium seatval2" id=""></span></td>
  </tr>
  <tr>
    <td>Seat Fare: (INR)</td>
    <td><span class="font-weight-medium seatvalamt2" id=""></span></td>
  </tr>
  <tr>
    <td colspan="2"><button class="btn btn-danger btn-block mfp-close" style="position: relative; color: #fff; background-color: #e52b30; font-size: 18px; font-weight: 700; width:100%;">Continue</button></td>
    </tr>
</table>
