...
$hrequest = array(
  ...
  //print_r($hrequest);
  $req=file_put_contents("FLYTBOJSON/TravbizzAuthReq.txt","$req");
$postdata = file_get_contents("FLYTBOJSON/TravbizzAuthReq.txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$result=file_put_contents("FLYTBOJSON/TravbizzAuthRes.txt","$flightRes");
