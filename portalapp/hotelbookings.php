...
include "headerinc.php";  
 ...
 $totalhotel=0; foreach($contentres['HotelBookings'] as $list) {  $b=1; ?> 
<div class="bookcarddetails1"   onclick="openWindow('<?php echo $fullurl; ?>preview_ticket.php?k=<?php echo  base64_encode($list['Voucher']); ?>');">
