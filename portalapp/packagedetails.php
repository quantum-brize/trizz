...
.next {
  ...
  padding: 8px; font-size: 18px; width: auto; transform: none !important; border-radius: 5px;
}
...
<div class="slider-wrapper">
  ...
  <div class="slider-container">
  	<?php
	$n=1;
	foreach($contentres['ImageGallery'] as $list){  
	 
	?>
    <img src="<?php echo stripslashes($list['image']); ?>"> 
	<?php } ?>
  </div>
...
<div class="whiteboxbodysection"> 
<div class="sectionheading" style="margin-bottom:5px; padding-left:0px; margin-left:0px;"><?php echo stripslashes($contentres['PackageDetails']['name']); ?></div>
<div style="overflow:hidden; padding-bottom:10px;">
<div class="daynight"><?php echo stripslashes($contentres['PackageDetails']['nights']); ?> Nights  / <?php echo stripslashes($contentres['PackageDetails']['days']); ?> Days</div><div class="flexboxpack"><?php echo stripslashes($contentres['PackageDetails']['theme']); ?></div><div style="float:left; padding-left:10px;"><?php echo stripslashes($contentres['PackageDetails']['destination']); ?></div>

</div>
<div style=" overflow:hidden;"><?php $inclustions=implode(',',array_unique(explode(',', stripslashes($contentres['PackageDetails']['includeServices'])))); ?>



<?php  if (strpos($inclustions, 'Flight') !== false) {   ?>
...
<?php  if (strpos($inclustions, 'Hotel') !== false) {   ?>
 <div class="incbox">
...
<?php   if (strpos($inclustions, 'Sightseeing') !== false) {    ?>
 <div class="incbox">
 ...
 <?php  if (strpos($inclustions, 'Transfer') !== false) {   ?>
 <div class="incbox">
 ...
 <div style=" text-align:center; font-weight:500;">Transfer</div>
  ...
  <?php  if (strpos($inclustions, 'Activity') !== false) {   ?>
 <div class="incbox">
 ...
 <?php  if (strpos($inclustions, 'Cruise') !== false) {  ?>
 <div class="incbox">
...
<?php if(trim($contentres['PackageDetails']['description'])!=''){ ?>
<div class="whiteboxbodysection"> 
<div class="sectionheading" style="margin-bottom:5px; padding-left:0px; margin-left:0px;">Package Overview</div>
<?php echo stripslashes($contentres['PackageDetails']['description']); ?>
</div>
<?php } ?>

 
<div class="whiteboxbodysection"> 
<div class="sectionheading" style="margin-bottom:5px; padding-left:0px; margin-left:0px;">Day Plan</div>
	<?php
	$n=1;
	foreach($contentres['DayDetails'] as $list){  
	
	if(trim($list['description'])!='' && trim($list['description'])!='Day 1' && trim($list['description'])!='Day 2' && trim($list['description'])!='Day 3'){ 
	?>
	<div style="background-color:#F9F9F9;">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr style="font-weight:600; font-size:15px;">
    <td colspan="2" align="center"><div style="padding:10px 10px; background-color:#EEEEEE; color:#000000; width:50px;">Day <?php echo $n; ?></div></td>
    <td width="96%" style="padding-left:10px;"><?php echo stripslashes($list['name']); ?></td>
  </tr>
</table>
<div style="padding:10px 0px; background-color:#FFFFFF; margin-bottom:20px;"><?php echo stripslashes($list['description']); ?></div>
	</div>
	<?php $n++; } } ?>
</div>


<div class="whiteboxbodysection" style="padding-bottom:80px;">  
	<?php
	$n=1;
	foreach($contentres['Terms'] as $list){   
	?>
	<div >
	<div class="sectionheading" style="margin-bottom:5px; padding-left:0px; margin-left:0px;"><?php echo stripslashes($list['name']); ?></div>
<div style="padding:10px 0px; background-color:#FFFFFF;"><?php echo stripslashes($list['description']); ?></div>
	</div>
	<?php $n++; } ?>
</div>
 

 <div style="position:fixed; left:0px; bottom:0px; width:100%; box-sizing:border-box; background-color:#FFFFFF; background-color:#000000; font-size:18px; padding:10px 20px;  font-weight:600;">
 
 <table width="100%" border="0" cellpadding="0" cellspacing="0" style="color:#FFFFFF;">
  <tr>
    <td colspan="2">₹<?php echo stripslashes($contentres['PackageDetails']['price']); ?><div style="margin-top:2px; font-size:12px;">Per Person</div></td>
    <td width="20%" align="right"><input name="submit" value="Send Enquiry" type="submit"  class="searchbigbtncom"  onclick="openWindow('<?php echo $fullurl.'packageenquiry.php?id='.$_REQUEST['id'].''; ?>&fromdate=<?php echo $_REQUEST['fromdate']; ?>');"/></td>
  </tr>
</table>
