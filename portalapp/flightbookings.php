...
include "headerinc.php";  
 ...
 $totalhotel=0; foreach($contentres['FlightBookings'] as $list) { $b=1; ?> 
<div class="bookcarddetails1"  onclick="openWindow('<?php echo $fullurl; ?>preview_ticket.php?k=<?php echo  base64_encode($list['Ticket']); ?>');"   >
