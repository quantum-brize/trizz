...
<table width="100%" border="0" cellspacing="0" cellpadding="5" style=" ">
  <tr>
    <td width="50%" align="left" valign="top" style="border-bottom:1px solid #ddd;" class="hcompanyinfo">
	<?php  if($LoginUserDetails['userType']=='agent'){  ?>
	<img src="<?php echo $imgurl; ?><?php echo $agentData['companyLogo']; ?>" height="55">
	<?php } else { ?>
	<img src="<?php echo $profilepic; ?><?php echo $websitesetting['websiteLogo']; ?>" height="55">
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
        ...
        <td width="25%" bgcolor="#D3F0FA" style="background-color:#D3F0FA;"> Rooms<br />
          <strong><?php echo stripslashes($editresult['RoomType']); ?> (<?php echo stripslashes($editresult['TotalRoom']); ?>)</strong></td>
...
$hotelData = $detailArray ;
 ...
 <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC" style=" font-size:13px; font-weight:600;">
  ...
  <?php if($editresult['CancellationPolicy']=='Refundable'){ echo 'Refundable - Cancellation Date: '.date('j F Y',strtotime($editresult['cancellationDate'])).' 23:30'; } else { echo 'This is Non-Refundable Booking.'; } ?>
 </td>
    </tr>
	<?php } ?>
