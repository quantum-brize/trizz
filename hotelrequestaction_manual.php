...
updatelisting('hotelBookingMaster','BookingNumber="'.$bookingNumber.'",status="'.$status.'",clientId="'.$clientId.'",agentId="'.$_SESSION['agentUserid'].'",bookingType=1,hotelRequest=1,agentBookingType=0','id="'.$_POST['bookinglastId'].'"'); 
