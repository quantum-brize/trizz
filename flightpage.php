...
@media (max-width: 575.98px) {
  .flightsearchwihite .lable{margin-left: 6px !important;padding: 9px 4px !important;font-size: 11px !important;}
  .searchboxouter .textfield{border-radius: 3px !important;padding: 14px 10px !important;font-size: 14px !important;padding-bottom: 14px !important;border: 1px solid #ddd !important;margin-bottom: -23px;height: 61px;background-color: rgb(247, 247, 247) !important;}
  #pickupCitySearchfromCity2{margin-left: 0px !important; background-color: rgb(247, 247, 247) !important;}
  .swapbtn{top: 64px !important; font-size: 14px !important;width: 34px !important;height: 34px !important;right: 25px;line-height: 34px !important;border: 1px solid #ddd; transform: rotate(90deg);border-radius: 3px !important;}
  ...
  .offerheading h3 {font-size: 17px; margin-left: 6px !important; }
  .holidestibox .card-body{background-color: transparent !important;top: 0px;}
  .flightsearchwihite{top: 48px !important;}
...
.top_bg_ofr_sb2other{border-radius: 0px !important; margin-top: -8px !important; margin-bottom: 70px !important; background-color: transparent !important;background-image: none !important;height: auto !important;}
.mobilecontainer{padding: 0px !important;}
.tablebordersearch{border: none !important;}
.searchboxouter{margin-top: 10px !important;border-radius: 0px !important;}
.top_bg_ofr_sb2other .searchtabs{width: 94%; margin: auto; background-color: #fff;border: 1px solid #ddd;border-radius: 3px;padding-left: 0px !important;}
.top_bg_ofr_sb2other .searchtabs a{text-align: center;padding: 5px;width: 50%;border-radius: 0px !important;margin-right: 0px !important;}
.top_bg_ofr_sb2other .searchtabs .active{background: linear-gradient(135deg, #002c57, #f95535);color: #fff !important;}
.flightsearchwihite .searchboxouter table tr td .fa-calendar{top: 35px !important;}
.flightsearchtable tr td:hover{background-color: transparent !important;}
.listlastflight{margin-left: 3px;}
#dt2{background-color: rgb(247, 247, 247) !important;}
.listlastflight{margin-top: 8px;margin-bottom: 8px;}
...
<div class="top_bg_ofr_sb top_bg_ofr_sb2other homeflightsearchouterbox" style="background-image: url(<?php echo $packagephotourl; ?><?php echo $pagecontentbanner['photo']; ?>); background-size: cover;">
...
<a class="active"  href="<?php echo $fullurl; ?>flights" ><span><i class="fa fa-plane" aria-hidden="true"></i></span>Flights</a>
<a href="<?php echo $fullurl; ?>hotels" ><span><i class="fa fa-building" aria-hidden="true"></i></span>Hotels</a>
<a href="<?php echo $fullurl; ?>holidays"><span><i class="fa fa-suitcase" aria-hidden="true"></i></span>Holidays</a> 
</div>
  ...
  <tr>
    ...
    <td id="companygstn"><select name="billingcompany" class="billingcompany" style="width:180px;padding: 5px; width: 180px; border: 1px solid #ddd; border-radius: 4px;">
               ...
               <?php
                  ...
                  ?>
               <option value="<?php echo encode($rest['id']); ?>"><?php echo strip($rest['companyName']); ?> - <?php echo strip($rest['state']); ?> - <?php echo strip($rest['gst']); ?></option>
               <?php } ?>
            </select></td>
    </tr>
</table>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="flightsearchtable">
      <tbody><tr>
        <td width="20%" align="left" valign="top" id="fromflightdestination"> 
         <label>
        <input type="hidden" name="tripType" id="tripType" value="<?php echo $tripType; ?>"><div class="lable" id="fromlabel">From</div>
        ...
        <td width="20%" align="left" valign="top" id="toflightdestination"  style="padding-left: 20px;">
         <label> <div class="lable tolabel" id="twolabel" style=" padding-left: 5px !important;">To</div>
        ...
        <td width="18%" align="left" valign="top">  <label><div class="lable" id="departurelabel">Departure</div><input type="text" id="dt1" name="journeyDateOne" class="textfield"  value="<?php echo trim($journeyDateOne); ?>" autocomplete="off" style="min-width: 140px;"  ><i class="fa fa-calendar" aria-hidden="true"></i></label>
...
function formatDate(date) {
    ...
    return [year, month, day].join('-');
        ...
        <input type="text" id="dt2" name="journeyDateRound" class="textfield"  value="<?php echo trim($journeyDateRound); ?>" autocomplete="off" <?php if($tripType==1){ ?>disabled  style="color:#000;" <?php } ?> disabled="disabled"  ><i class="fa fa-calendar" aria-hidden="true"></i>  <div class="sublinesearch flightreturndate"></div></label></td>
	...
	<input type="text" id="travellersshowdisplay"  class="textfield"  value="<?php echo trim($toairportpax); ?>" autocomplete="off" readonly="readonly" onClick="$('#mobileflightsearchpax').show();"   >
...
<div style="background-color: #f2f2f2; border-radius: 10px; display:inline-block; width:auto;text-align: center; height: 39px; overflow: hidden; border-radius:8px;"> 
 <label><table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td valign="bottom"  style="padding:10px 5px 10px 10px !important;line-height: 13px; "><input name="directflight"  type="checkbox" value="1" ></td>
        ...
        <table border="0" align="right" cellpadding="0" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td colspan="3">
                            <div class="searchhistory" style="background-color: #f2f2f2; border-radius: 10px; display:inline-block; width:auto;text-align: center; height: 39px; overflow: hidden; border-radius:8px;">
                              ...
                              ?>
                                ...
                                <a href="flight-search?tripType=<?php echo stripslashes($flighthistory['tripType']); ?>&fromcitydesti=<?php echo stripslashes($flighthistory['userFrom']); ?>&fromDestinationFlight=<?php echo stripslashes($flighthistory['fromDestinationFlight']); ?>&tocitydesti=<?php echo stripslashes($flighthistory['userTo']); ?>&toDestinationFlight=<?php echo stripslashes($flighthistory['toDestinationFlight']); ?>&journeyDateOne=<?php echo date('d-m-Y', strtotime($flighthistory['userDeparture'])); ?>&journeyDateRound=<?php if (date('d-m-Y', strtotime($flighthistory['userArrival'])) > '1970-01-01') {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          } ?>&travellersshow=1+Pax%2C+Economy&ADT=1&CHD=0&INF=0&PC=EC&Submit=SEARCH&action=flightpostaction&changesearch=0" class="flighttrandingsearch">
...
<div class="card pkgdst" style="box-shadow: 0px 0px 10px #00000029; border: 0px; margin-top: 0px;">
	...
	<div class="col-lg-6">
	 <div class="row packagedestiall">
		...
		<div class="populerdestinations" style="background-image:url(<?php echo $packagephotourl; ?><?php echo stripslashes($destinationMaster['photo']); ?>);  <?php if($k>2){ ?>margin-bottom:0px; <?php } ?>">
		<div class="shade">
		<div class="textfont"><?php echo stripslashes($destinationMaster["name"]); ?>
		<div class="pricefont">Price Starts from <span>₹ <?php echo $packageprice['grossPrice']; ?></span></div>
	...
	<div class="populerpackagelistouter">
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="top"><div class="imgbox" style="background-image:url(<?php echo $packagephotourl; ?><?php echo $packagelist['coverPhoto']; ?>" ></div></td>
    <td width="90%" align="left" valign="top"><div class="packagename"><?php echo stripslashes($packagelist['name']); ?></div><div class="packagetext"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo ($packagelist['days']-1); ?> Nights / <?php echo $packagelist['days']; ?> Days</div></td>
    <td align="left" valign="top"><div class="prince">₹ <?php echo $packagelist['grossPrice']; ?></div></td>
  </tr>
</table>
	...
	<div class="row blogsecmobile">
              ...
              ?>
                <div class="col-lg-3" style="cursor:pointer; margin-bottom:20px;">
                  <a href="<?php echo $fullurl; ?>post-view?id=<?php echo encode($spdeals['id']); ?>&t=<?php echo seo_friendly_url(stripslashes($spdeals['name'])); ?>" target="_blank">
				    <div class="popblog" style="background-image:url(<?php echo $blogphoto; ?><?php echo $spdeals['photo']; ?>);"> 
					<div class="shade"><div class="textfont"><?php echo stripslashes($spdeals['name']); ?></div></div>
