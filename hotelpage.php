...
$rs=GetPageRecord('*','cmsPages','url="hotel_page_banner"');  
...
.starnd{margin-bottom: 0px !important;}
  ...
  .flightsearchwihite .lable{margin-left: 6px !important; top: 22px !important; padding: 9px 4px !important; font-size: 11px !important;}
  .searchboxouter .textfield{border-radius: 5px !important;font-size: 14px !important;padding-bottom: 14px !important;margin-top: 10px !important;border: 1px solid #ddd !important;height: 61px !important; margin-bottom: -23px !important;margin-top: 0px !important;padding: 14px 10px !important;}
...
.hotelmainbg{height: auto !important;margin-bottom: 55px !important;}
.top_bg_ofr_sb2other{margin-top: -208px !important; border-radius: 0px !important; margin-top: 20px !important; background-image: none !important;background-color: transparent !important;}
.flightsearchwihite .searchboxouter .tableborder table tr td{display: inline-block; text-align: center !important; line-height: 0px;width: 100% !important;border: none !important;}
.flightsearchwihite { background-color: transparent !important; padding: 0px !important; }
.tableborder { border: none !important; }
.flightsearchwihite{box-shadow: none !important;}
.searchboxouter .textfield{ border-left: 1px solid #ddd !important; background-color: rgb(247, 247, 247) !important;    border: 1px solid #ddd !important;}
#dt2{background-color: rgb(247, 247, 247) !important;    border: 1px solid #ddd !important; }
#travellersshow{margin-bottom: -8px !important;}
.flightsearchwihite .searchboxouter .redbuttonsearch{margin-top: 26px !important;max-width: 94% !important; border-radius: 3px !important; margin-bottom: 15px !important; margin-left: -4px;}
.searchboxouter{padding-right: 0px !important;margin-top: 0px !important;background-color: #fff;border-radius: 0px !important;margin-top: 0px !important;}
.mobilecontainer{padding: auto !important;}
.mobilecontainer{padding: 0px !important;}
.hoteltableborder table tr td .fa-calendar{top: 32px !important;}
.fa-calendar:before{font-size: 15px !important;}
.hoteltableborder tr td:hover{background-color: transparent !important;}
}
...
.searchdestinationboxclass { top: 58px; }
</style>
...
<div class="top_bg_ofr_sb top_bg_ofr_sb2other homeflightsearchouterbox hotelmainbg" style="background-image: url(<?php echo $packagephotourl; ?><?php echo $pagecontentbanner['photo']; ?>); background-size: cover;">
  <div class="flighttopmenuwithback">
    ...
    <div class="container mobilecontainer" style="padding: 0px 20px;  padding-top: 278px;"> 
    <div class="flightsearchwihite hotelsearchwhite">
     <div class="domheading"> 
<a href="<?php echo $fullurl; ?>flights" ><span><i class="fa fa-plane" aria-hidden="true"></i></span>Flights</a>
<a class="active"  href="<?php echo $fullurl; ?>hotels" ><span><i class="fa fa-building" aria-hidden="true"></i></span>Hotels</a>
<a href="<?php echo $fullurl; ?>holidays"><span><i class="fa fa-suitcase" aria-hidden="true"></i></span>Holidays</a> 
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <input name="destinationHotel" id="destinationHotel" type="hidden" value="<?php echo $destinationHotel; ?>" autocomplete="nope">
		  ...
		  <div class="sublinesearch destinationhotelcountry">India</div>     
		  </td> 
        <td width="18%" align="left" valign="top"> <label>   <div class="lable" id="departurelabel">CHECK IN</div><input type="text" id="dt1" name="checkInDate" class="textfield"  value="<?php echo trim($checkInDate); ?>" autocomplete="off"  ><i class="fa fa-calendar" aria-hidden="true"></i></label>
		<div class="sublinesearch fromdatehotel">Monday</div>
	</td>
		...
		<div class="sublinesearch todatehotel">Tuesday</div>
...
function formatDate(date) {
    ...
    return [year, month, day].join('-');
		...
		$('.fromdatehotel').text(getWeekday(dt));
		$('.todatehotel').text(getWeekday(dtt));  
 ...
 <div id="basicDropdownClick" class="dropdown-menu dropdown-unfold col-11 m-0" aria-labelledby="basicDropdownClickInvoker" style="max-width: 510px; width:510px; padding:10px; right:0px;">
  ...
  <tr>
    <td><label><input name="category[]" type="checkbox" value="1" style="width: 20px; height: 16px; float: left; margin-right: 3px;"  onclick="combinecheckbox()"   checked="checked"   /> 1 Star</label></td>
    </tr>
  <tr>
    <td><label><input name="category[]" type="checkbox" value="2" style="width: 20px; height: 16px; float: left; margin-right: 3px;" onClick="combinecheckbox()"   checked="checked"/> 2 Star</label></td>
    </tr>
  <tr>
