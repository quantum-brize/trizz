...
<div style="margin:10px 0px; color:#000000; font-weight:500; text-align:left;">Traveller's Contact Details</div>
<table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#000000">
      <tr>
 <td bgcolor="#E9E9E9"><strong>Email Id</strong></td>
  <td bgcolor="#E9E9E9"><strong>Mobile No.</strong></td>
	</tr>
	 <?php 
	  $ns=1;
		$rs6=GetPageRecord('*','flightBookingPaxDetailMaster',' BookingId="'.$editresult['id'].'" '.$wheretp.' and firstName!="" '); 
    ...
    if (!$contactDetailsCaptured) {echo '<tr>';
      echo '<td>';if ($paxData['email'] != '') {echo $paxData['email']; } elseif ($editresult['email'] != '') {echo $editresult['email'];}echo '</td>';
      
      echo '<td>'; if ($paxData['mobile'] != '') {echo $paxData['mobile'];} elseif ($editresult['mobile'] != '') { echo $editresult['mobile'];} echo '</td>';
      
      echo '</tr>'; $contactDetailsCaptured = true;}
    $ns++;
  }
  ?>
</table>
