...
<table width="100%" border="0" cellpadding="5" style="font-size:12px; ">
  <tr>
    <td width="34%" align="left"><img src="<?php echo $imgurl; ?><?php echo $adminData['companyLogo']; ?>" height="55"></td>
    <td width="33%">&nbsp;</td>
  ...
  <tr>
    ...
    <td width="33%" align="right"><table width="100%" border="0" cellpadding="0">
      <tr>
        ...
        <td width="44%" align="right"><?php echo round($rest['agentTotalFare']-$rest['agentMarukup']-$rest['clientTax']); ?> INR</td>
      </tr>
      
      <tr>
        <td align="right">Taxes</td>
        <td align="center">:</td>
        <td align="right"><?php echo number_format($rest['clientTax']); ?> INR</td>
      </tr>
    ...
    <tr>
      ...
      <tr>
        ...
        <td align="right"><strong><?php echo round($rest['agentTotalFare']-$rest['agentMarukup']); ?> INR</strong></td>
      </tr>
    </table></td>
  </tr> 
  <tr>
