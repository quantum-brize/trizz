...
$noshowmenu='yes';
$rs=GetPageRecord('*','cmsPages','url="package_page_banne"');  
...
<head>
  ...
  <style>
    ...
    @media (max-width: 575.98px) {
      ...
      .holidestibox .fa-calendar:before {
        top: 0px !important;
        right: 5px !important;
        font-size: 13px !important;
      }
      .populerdestinations{margin-bottom: 20px !important;}
    ...
    .holidaysearch .textfield option {
    ...
    .holiimg {border-top-right-radius: 4px !important;border-top-left-radius: 4px !important;height: 250px;}
    .holidestibox .card{border-radius: 4px !important;}
    .holipricing{justify-content: space-between !important;margin-top: 20pxx`;}
    .holidestibox{margin-top: 0px !important;}

    @media(max-width: 576px){
      .textcontent{margin-top: 10px !important;}
      .holidaysearch{padding: 0px !important;background-color: transparent !important;}
      .holidaybanner{height: 240px !important;}
      .holidaysearch h1{display: none !important;}
      #formids{border: none !important;}
      .holidaysearch tr td{display: block !important;width: 100% !important; padding: 0px !important;border: none !important;}
      #formids{padding: 0px !important;}
      .labeldiv{display: none !important;}
      .holidaysearch .textfield{margin-bottom: 5px !important;border-radius: 4px !important;padding: 13px 10px !important;margin-left: 0px !important;}
      .populerdestinations{height: 155px !important;}
      .whatsapp { font-size: 28px; background-color: #27bc3a; position: fixed; left: 10px; bottom: 9px; border-radius: 50px; padding: 0px; width: 45px; height: 45px; text-align: center; padding-top: 9px; color: #fff;}
      .holidaydestination .row{display: flex; width: 107%; overflow: auto; flex-wrap: nowrap; padding-bottom: 10px;}
...
<body class="greybluebg">
  ...
  <section class="holidaybanner" style="background-image: url(<?php echo $packagephotourl; ?><?php echo $pagecontentbanner['photo']; ?>); background-size: cover;">
...
<a class="active" href="<?php echo $fullurl; ?>holidays"><span><i class="fa fa-suitcase" aria-hidden="true"></i></span>Holidays</a> 
</div>

          <div class="holidaysearch">
            <h1 style="color:#000;"> Book Domestic and International Holiday Packages</h1>
            <form method="GET" id="formids" action="<?php echo $fullurl; ?>holidays-search">
              <table>
                <tbody>
                  <tr>

                    <td width="60%" style="border-right: 1px solid #ebebeb;padding-right:20px;">
                      <label class="labeldiv">Find Holidays by Destination</label>
                    ...
                    <td width="" style="padding-left: 20px;">
                      <label class="labeldiv">STARTING ON</label>
                      <input type="text" id="dt3" name="journeyDateOne" class="textfield" value="Any Time" autocomplete="off" style="min-width: 140px;">
                    </td>

                    <td width="15%"><input type="submit" name="Submit" value="Search Packages" class="redbuttonsearch"><input type="hidden" name="action" value="flightpostaction">
  ...
  <div class="textcontent">
    <div class="container">
      ...
      <div class="offerheading">
        <h3 class="homedealsheading">Popular <span>Destinations</span></h3>
      </div>
      <div class="card" style="box-shadow: 0px 0px 10px #00000029; border: 0px; margin-top: 0px;">
        <div class="card-body" style="padding: 20px;">
          <div class="row ">
            <div class="col-lg-12">
              <div class="row topdestialls">

                <?php
                $k = 1;
                $dm = GetPageRecord('*', 'websiteDestination', 'name in (SELECT destinations FROM sys_packageBuilder WHERE 1)  order by rand() limit 8');
                while ($destinationMaster = mysqli_fetch_array($dm)) {
                ...
                ?>
                  ...
                  <div class="col-lg-3">
                    <a href="holidays-search?holidaysdestination=<?php echo stripslashes($destinationMaster["name"]); ?>&Submit=SEARCH&action=flightpostaction&changesearch=0">
                      <div class="populerdestinations" style="background-image:url(<?php echo $packagephotourl; ?><?php echo stripslashes($destinationMaster['photo']); ?>);  <?php if ($k > 4) { ?>margin-bottom:0px; <?php } else { ?>margin-bottom:20px !important;<?php } ?>">
                        <div class="shade">
      ...
      <section class="holidaydestination">
        ...
        <div class="offerheading" >
        <h3 class="homedealsheading" style="margin-bottom: 5px;">Popular <span>Packages</span></h3>
      </div>
          <div class="row">
            ...
            $where = '';
            $p = 1;
            $bb = GetPageRecord('*', 'sys_packageBuilder', '  showwebsite=1  and queryId=0 and grossPrice>0  order by rand() asc  limit 0,8   ');
              ...
              <div class="col-lg-3">
                <div class="holidestibox phoneholibox">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <h5 class="card-title"><a target="_blank" href="<?php echo $fullurl; ?>package/<?php echo stripslashes($packagelist['seoURL']); ?>" style="color:#000000;"><?php echo stripslashes($packagelist['name']); ?></a></h5>
                     
                      <div style="text-align:left;color:#525252;font-weight:500;"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo ($packagelist['days'] - 1); ?> Nights / <?php echo ($packagelist['days']); ?> Days</div>
                      <div class="holipricing">
                        <div class="pricest" style="color:#525252;">Starting Price</div>
                       <div><p><a href=""><?php echo convertfromtocurrencywithcurr('INR', $_SESSION['currency'], round($packagelist['grossPrice'])); ?></a></p></div> 
                      </div>
                    </div>
                  </div>
                </div>
