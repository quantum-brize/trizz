                        ...
                        <table class="table table-hover mb-0">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td width="1%">
                                    <a class="dropdown-item neweditpan" onclick="loadpop2('Edit Destination',this,'600px')" data-toggle="modal" data-target="#myModal2" data-backdrop="static" popaction="action=addwebsitedestination&id=<?php echo encode($rest['id']); ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>   
                                 </td>
                              </tr>
                              <?php $totalno++; } ?>
                           </tbody>
