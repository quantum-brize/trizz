...
<input id="surl" class="surl" name="surl" value="https://pay.tsbizz.com/response.php" type="hidden">
<input id="furl" class="furl" name="furl" value="https://pay.tsbizz.com/response.php" type="hidden">
