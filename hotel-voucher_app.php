<?php   
include "inc.php"; 
$rs=GetPageRecord('*','hotelBookingMaster','BookingNumber="'.base64_decode($_REQUEST['i']).'" '); 
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" style=" ">
  <tr>
    <td width="50%" align="left" valign="top" style="border-bottom:1px solid #ddd;" class="hcompanyinfo"><img src="<?php echo $imgurlagent; ?><?php echo $agentData['companyLogo']; ?>" height="44"></td>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
  <tr>
	...
	<?php echo $editresult['CancellationPolicy']; ?><br /><br /></td>
    </tr>
  <tr>
...
13. Additional GST Payment (if any) to be paid to the hotel directly by the guest.<br /></td>
    ...
    <td width="11%" align="right" style="font-size:16px;" class="withoutfare">&#8377;<span  id="displayhtotalamount" ><?php echo round($editresult['agentTotalFare']); ?></span><input  id="htotalamount" type="hidden" value="<?php echo round($editresult['agentTotalFare']); ?>" /></td>
  </tr>
  <?php } ?>
</table>
